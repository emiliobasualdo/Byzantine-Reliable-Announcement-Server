...
class ServerThreadTest {
    ...
    @Test
    void test_illegal_first_signature_returns_error() throws IOException, InvalidKeyException, BadPaddingException, NoSuchAlgorithmException, IllegalBlockSizeException, NoSuchPaddingException {
    ...
    @Test
    void test_illegal_second_signature_returns_error() throws IOException, InvalidKeyException, BadPaddingException, NoSuchAlgorithmException, IllegalBlockSizeException, NoSuchPaddingException {
    ...
    @Test
    void test_illegal_post_signature_returns_error() throws IOException, InvalidKeyException, BadPaddingException, NoSuchAlgorithmException, IllegalBlockSizeException, NoSuchPaddingException {
    ...
    @Test
    void test_duplicate_first_package_returns_error() throws IOException, InvalidKeyException, BadPaddingException, NoSuchAlgorithmException, IllegalBlockSizeException, NoSuchPaddingException {
